...
var findAllTasks = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$query, size, page, title, condition, _getPagination, limit, offset, tasks;
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            res.json({
              message: "id: ".concat(id, ", Task were deleted succesfully")
            });
            _context4.next = 10;
            break;
          ...
          case 7:
            ...
            res.status(500).json({
              message: _context4.t0.message || "Error deleting task with id: ".concat(id)
            });
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            res.json({
              message: "task was updated succefully"
            });
